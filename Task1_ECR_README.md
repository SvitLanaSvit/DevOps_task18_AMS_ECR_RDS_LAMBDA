...
- Натисніть **"Next"**
![Створення Access Key](Screens_ecr/1.1.1_create_credentiol_key.png)
...
![Збереження Access Key](Screens_ecr/1.1.2_create_credentiol_key.png)
...
![Налаштування ECR](Screens_ecr/1.2.1_create_ecr.png)
...
![Створення ECR](Screens_ecr/1.2.2_create_ecr.png)
...
docker images
```
![Збірка образу](Screens_ecr/1.3.1_build_image.png)
...
```
![Тестування образу](Screens_ecr/1.3.2_test_after_build.png)
...
```
![Login та Push](Screens_ecr/1.4.2_login_push_image_to_ecr.png)
...
![Результат в ECR](Screens_ecr/1.5.1_result_image_on_ecr.png)
